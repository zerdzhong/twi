...
- (id)initWithDict:(NSDictionary *)dict{
    if (self = [super init]) {
        ...
        self.repostsCount =  [dict[@"reposts_count"] integerValue];         //转发数
        self.commentsCount = [dict[@"comments_count"] integerValue];        //评论数
        self.attitudesCount = [dict[@"attitudes_count"] integerValue];       //表态数
...
- (void)setSource:(NSString *)source{
    ...
    int beg = [source rangeOfString:@">"].location + 1;
