...
- (void)setStatus:(StatusModel *)status{
    ...
    if (_status.picURLs.count) {
        ...
        CGSize size = [PictureListView pictureListSize:_status.picURLs.count];
        ...
        if (_status.reStatus.picURLs.count) {
            ...
            CGSize size = [PictureListView pictureListSize:_status.reStatus.picURLs.count];
